...
<%
	...
	ArrayList<Item> items = (ArrayList<Item>) request.getAttribute("itemRecherche");
%>
<%
	@SuppressWarnings("unchecked")
		...
		<main id="container">
			<div id="contenu">
				...
				<div class="itemDescription">
					<div>
						<img src="<%=Const.IMAGE_PRODUCT + item.getImage()%>" alt="">
					</div>
					<p><%=item.getName()%></p>
					<p><%=item.getDescription()%></p>
					<p><%=item.getPrice()%></p>
					<form method="post" action="" id="form-add-item">
			...
			<div class="">Aucun produit ne correspond a votre demande.</div>
			<%
				}
			%>
		</main>
